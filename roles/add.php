           ...
           <!--  GET => envia datos a traves de la url del navegador (URI) al servidor
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ingrese el nombre del rol">
                    <?php if(isset($msg)): ?>
                        <p class="text-danger">
                            <?php echo $msg; ?>
                        </p>
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="valida()">Guardar</button>
...
<script type="text/javascript">
    function valida(){
        ...
        if (nombre==0) {
            ...
            alert("ingresa el nombre del rol por favor");
